...
class RewardMonitor():
    ...
    def __init__(self, trials: int, gui_parent: pg.GraphicsLayoutWidget, visual_output: bool, reward_range: list = [0, 1]):
        '''
...
class ResponseMonitor():
    ...
    def __init__(self, trials: int, gui_parent: pg.GraphicsLayoutWidget, visual_output: bool):
        '''
...
class EscapeLatencyMonitor():
    ...
    def __init__(self, trials: int, max_steps: int, gui_parent: pg.GraphicsLayoutWidget, visual_output: bool):
        # store the GUI parent
        self.gui_parent = gui_parent
...
class TrajectoryMonitor():
    ...
    def __init__(self, max_steps: int, gui_parent: pg.GraphicsLayoutWidget, visual_output: bool):
        # store the GUI parent
        self.gui_parent = gui_parent
        self.max_steps = max_steps
        # shall visual output be provided?
...
class UnityPerformanceMonitor:
    ...
    def __init__(self, gui_parent: pg.GraphicsLayoutWidget, visual_output: bool, reward_plot_viewbox=(-100, 10, 50),
